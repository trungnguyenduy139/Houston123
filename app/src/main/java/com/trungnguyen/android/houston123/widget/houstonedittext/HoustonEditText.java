package com.trungnguyen.android.houston123.widget.houstonedittext;
 ...
 * </pre>
 */
public class HoustonEditText extends AppCompatEditText implements OnTouchListener, OnFocusChangeListener, TextWatcherAdapter.TextWatcherListener {
    ...
    public HoustonEditText(Context context) {
        super(context);
        init();
    }

    public HoustonEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HoustonEditText(Context context, AttributeSet attrs, int defStyle) {
