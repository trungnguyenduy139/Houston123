...
public interface IUserListView extends IBaseView {
    ...
    void doLoadMore(Collection<? extends BaseModel> userModels, boolean hasLoader);

    void doRefreshList(Collection<? extends BaseModel> usersModels, boolean hasLoader);
